...
-- CreateIndex
CREATE INDEX "story_name_idx" ON "public"."story"("name");
...
-- AddForeignKey
ALTER TABLE "public"."storyStep" ADD CONSTRAINT "storyStep_storyId_fkey" FOREIGN KEY ("storyId") REFERENCES "public"."story"("id") ON DELETE CASCADE ON UPDATE CASCADE;
